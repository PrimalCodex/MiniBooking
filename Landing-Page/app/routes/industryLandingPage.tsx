            ...
            <div className="flex flex-col h-auto w-full gap-4 lg:w-full">
              <div className="flex flex-col lg:flex-row lg:h-[3.8rem] gap-4 lg:gap-0">
                ...
                <button
                  ...
                  className="w-full h-auto px-3 py-4 lg:text-[0.9rem] bg-customBrown
                  text-white lg:w-[8rem] rounded lg:rounded-r-lg"
                >
              ...
              {submitted && (
                <div className="flex flex-row w-full h-full gap-1">
                  ...
                  <p className="w-full font-custom font-normal text-[14px] text-waitingList">
